...
export default function PortfolioCTA() {
  return (
    <section className="relative py-28 px-6 overflow-hidden">
      ...
      <svg className="absolute top-10 right-10 w-48 h-48 opacity-20 z-[3]" viewBox="0 0 100 100" fill="none">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        <motion.div
          ...
          <h2 className="font-serif text-4xl md:text-6xl font-semibold text-white mb-6"
            ...
            Ready to be<br />
            <span className="italic font-normal">our next case study?</span>
          </h2>
          <p className="text-lg md:text-xl text-white/85 max-w-2xl mx-auto mb-10">
            Bring us your idea — the rougher, the better. We'll scope it, price it, and send you a full proposal within 48 hours.
          </p>
