...
export default function FeaturesCTA() {
  return (
    <section className="relative py-28 px-6 overflow-hidden">
      ...
      <svg className="absolute top-10 right-10 w-40 h-40 opacity-20 z-[3]" viewBox="0 0 100 100" fill="none">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        <motion.div
          ...
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm border border-white/25 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-white">Now accepting Q2 projects</span>
          </div>

          <h2 className="font-serif text-4xl md:text-6xl font-semibold text-white mb-6"
            style={{ letterSpacing: "-0.02em", lineHeight: 1.05 }}>
            Convinced, or<br />
            <span className="italic font-normal">still curious?</span>
          </h2>
          <p className="text-lg md:text-xl text-white/85 max-w-2xl mx-auto mb-10">
            Either way, let's talk. Book a free 30-minute call — we'll answer every question and send you a detailed quote within 48 hours.
          </p>
